...
<head>
    ...
    <title>participate signin Page</title>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_participant = "INSERT INTO participants(p_id,p_name, email, institution_name, contact, dob, address) 
                        VALUES ( '$user_id','$name', '$email', '$cname', '$mobile', '$dob', '$address')";
    ...
    $query = "SELECT * FROM participants WHERE p_id = '$user_id'";
...
?>
    <div id="participate-signin-box">
        <h2>participate signin</h2>
        <form action="participatesigninpage.php" method="post" onsubmit="return validateAndLogin(event)">
        ...
        <input type="submit" value="Participate" id="id1">
    </form>
    </div>
